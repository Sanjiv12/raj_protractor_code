...
#Scenario: VLP - Year
  ...
  #Given User is in Vehicle List Page with all filters cleared
...
#Scenario: VLP - Cab
  ...
  #Given User has selected a Truck model
  #When User selects a cab option from Filters panel
...
#Scenario: VLP - Bed Length
  ...
  #Given User has selected a Truck model
  #When User selects a Bed Length option from Filters panel
