...
export const config: Config = {
  ...
  //   baseUrl:
  //     "https://qa.smartpath.tldealersystems.com/inventory?dealerCd=24022&source=t1",
  ...
  cucumberOpts: {
    require: [
      "../../typeScript/stepdefinitions/**/*.step.js",
      "../../typeScript/util/*.js",
    ],
  ...
  suites: {
    ...
    gxpcreateaccountbanner:
      "../../features/**/gxp-create-account-banner.feature",
    gxpsso: [
  ...
  onPrepare: async () => {
    ...
    browser.driver
      .manage()
      .timeouts()
      .implicitlyWait(WAIT_TIMES.IMPLICIT_WAIT_TIME);
